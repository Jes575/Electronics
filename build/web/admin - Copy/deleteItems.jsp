...
<div>
        <table align="center">
            ...
            <tr><th width="8%">Product Code</th><th width="12%">Product Name</th><th width="10%">Date</th><th width="8%">Product Quantity</th><th width="25%">Product Description</th><th width="12%">Product Image Name</th><th width="10%">Price</th><th width="10%">Product Type</th><th width="5%">Delete Inventory</th></tr>	
        <% 
        try {
            ...
            <tr style="background-color: <% out.print("#eee"); %> ">
                ...
                <td><a href="deleteItems.jsp?code=<%=rs.getString(1) %>"><img src="../images/remove.png" name="delete" width="30px" height="30px" /></a></td>
                </tr> <%
            }
