...
<tr>
  ...
  <td width="164" height="31" id="pos"><input type="text" name="pcode" value="<%=rs.getString(1) %>" readonly="readonly" /></td>  
</tr>
<tr>
  <td width="120" height="31" id="label">Product Name :</td>
  <td width="164" height="31"  id="pos"><input type="text" name="name" value="<%=rs.getString(2) %>"></td>  
</tr>
<tr>
  <td width="120" height="31" id="label">Date :</td>
  <td width="164" height="31" id="pos"><input type="date" name="date" value="<%=rs.getString(3) %>"></td>  
</tr>
<tr>
  <td width="120" height="31" id="label">Quantity :</td>
  <td width="164" height="31" id="pos"><input type="text" name="qty" value="<%=rs.getString(4) %>"></td>  
</tr>
<tr><td width="120" height="31" id="label">Description :</td><td width="164" id="pos"><textarea cols="30" rows="4" name="desc"><%=rs.getString(5) %></textarea></td></tr>
<tr>
  <td width="120" height="31" id="label">Price :</td>
  <td width="164" height="31" id="pos"><input type="text" name="price" value="<%=rs.getString(7) %>"></td>  
</tr>
<tr>
  <td width="120" height="31" id="label">Type :</td>
  <td width="164" height="31" id="pos"><label><%=rs.getString(8) %></label></td>  
</tr>
<% }
    rs.close();
    con.close();
