...
<body><div>
        <table align="center">
            ...
            <tr><th width="8%">Product Code</th>
                ...
                <th width="5%">Update Inventory</th></tr>	
        <% 
        try {
            ...
            while(rs.next()) { 
               ...
               <td><%=rs.getString("code") %> </td>
                ...
                <td><button onclick="window.open('editItems.jsp?code=<%=rs.getString("code") %>','Update Items','width=500,height=400')">Update Item</button></td>
                </tr> <%
            }
